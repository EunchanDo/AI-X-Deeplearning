...
**Ⅰ. Proposal(Option A)**
  ...
  - Motivation:
  <br> 국내 사망원인 1위 질환인 암 다음으로 우리의 목숨을 위협하는 가장 무서운 질병은 바로 심장질환이다.  심장질환은 돌연사의 원인이 되기도 하며 고령 환자의 주요 사망 원인이다. 국내에서는  매년 20만명이 넘는 환자들이 심부전으로 병원을 찾을 정도이다.  심장 질환은 한국내에서만 무서운 병이 아니다. 다른 여러 국가에서도 사망 원인이 되는 심각한 질환이고 특히 미국 내에서는 전 인종이 영향을 받은 주된 사망원인 중 하나이다.  미국 CDC의 통계자료에 따르면 미국인들의 절반이 심장병의 세 가지 주요 원인 중 적어도 한가지를 가지고 있다고 한다. 그 세가지는 바로 고혈압,  고 콜레스테롤 그리고 흡연이다. 이것들 외에도 육체 및 정신의 건강한 정도, 뇌졸중 경험 여부 그리고 음주 등 다양한 원인들이 존재한다. 따라서 이러한 원인들을 분석하여 심장병 발생 여부를 예측하는 것은 인류의 중대한 과업이라고 할 수 있다.  그러한 과업에 동참하기위해 우리 팀은 미국 CDC의 방대한 심장 질환 지표 데이터를 활용하여 그것을 예측할 수 있는 모델을 만들고 어떤 AI 모델이 최적의 결과를 제시할 수 있는지 분석할 것이다. 
